            ...
            <div className="w-1/3  flex justify-center h-96">
                <div className="flex items-center flex-col justify-center">
                    ...
                    <div className="">
                        ...
                        <div  >
                            <button className="text-sm uppercase  my-3 border-gray-500 rounded-lg block w-full p-2 text-black border ">Login</button>
                            <br />
                            <button className="text-xs uppercase  my-3 border-gray-500 rounded-lg block w-full p-1 text-black border " onClick={() => location('/registration')}>Registration</button>
